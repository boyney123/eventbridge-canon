...
import { IModalProps, ILog } from '@/types/index';

interface IViewEventProps extends IModalProps {
  log?: ILog | null;
  onResend: (newEvent: ILog) => void;
}

export default function ViewEventModal({ isOpen = false, onResend, onCancel = () => {}, log }: IViewEventProps) {
            ...
            <div className="inline-block align-bottom bg-white rounded-lg px-4 pt-5 pb-4 text-left overflow-hidden shadow-xl transform transition-all sm:my-8 sm:align-middle sm:max-w-3xl sm:w-full sm:p-6">
              <div>
                <div className="mt-3 sm:mt-5">
                  ...
                  <p className="text-gray-500 text-xs">This event was previously sent. You can see the payload below.</p>
                  <div className="my-8 space-y-4">
                    <div className={`flex content-center justify-center `}>
                      ...
                      <Editor theme="vs-dark" value={JSON.stringify(log.payload, null, 4)} options={{ readOnly: true }} />
                    </div>
                  </div>
                </div>
              </div>
